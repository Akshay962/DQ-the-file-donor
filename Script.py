...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ...\n\n╔═════ 🔎🔸🔸🔸🔍 ════╗\n\n<a href=https://www.google.com>🔍 𝗖𝗹𝗶𝗰𝗸 𝗧𝗼 𝗖𝗵𝗲𝗰𝗸 𝗦𝗽𝗶𝗹𝗹𝗶𝗻𝗴 ✅</a>\n\n╚═════ 🔎🔹🔹🔹🔍 ════╝\n\n⚠️ Note:-Search Movies from Google Copy the Name and Paste it"""

    MVE_NT_FND = """Your Movie Not Available in My Database

Not Release OTT yet

If Your Movie is Released on OTT Then Not Add my Database Send Request to Admin to Add Your Movie..
