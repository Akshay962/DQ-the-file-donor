...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Hii {message.from_user.mention} 🌹\n\nYour Movies and web series Available in My Group 📩\n\n🔎 Join Group and Search Again\n\n✅ Join Group\n\n╔═════════╗\n\n<a href=https://t.me/+7p7DwzUq5WdmYWU1>👉𝗝𝗼𝗶𝗻 𝗚𝗿𝗼𝘂𝗽👈</a>\n\n╚═════════╝</b>")
    await bot.send_message(
        chat_id=-1001893557784,
        text=f"<b>#𝐏𝐌_𝐌𝐒𝐆\n\nNᴀᴍᴇ : {user}\n\nID : {user_id}\n\nMᴇssᴀɢᴇ : {content}</b>"
    )
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            await bot.send_message(chat_id=-1001893557784, text=(script.NORSLTS.format(reqstr.id, reqstr.mention, movie)))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɢʟᴏʙᴀʟ', callback_data='global_filters')
        ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴄᴏɴɴᴇᴄᴛᴏɴ', callback_data='coct'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/AkshayChand10")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
        ...
        if len(message.text) < 100:
            ...
            if not files:
                if settings["spell_check"]:
                    ...
                    await client.send_message(chat_id=-1001893557784, text=(script.NORSLTS.format(reqstr.id, reqstr.mention, search)))
                    return
        else:
            return
    else:
...
async def advantage_spell_chok(client, msg):
    ...
    gs_parsed = []
    if not g_s:
        await client.send_message(chat_id=-1001893557784, text=(script.NORSLTS.format(reqstr.id, reqstr.mention, mv_rqst)))
